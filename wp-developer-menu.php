 ...
 * Main plugin file.
 *
 * @package    WordPress Developer Menu
 * @license    GPL2
 * @author     Adam Taylor <sayhi@iamadamtaylor.com>
 */

/**
 * Plugin Name: WordPress Developer Menu
 * Description: Adds custom functions (available to developers) to make outputting navigation menus easier.
 * Version: 1.0.0
 * Author: Adam Taylor <sayhi@iamadamtaylor.com>
...
/*  Copyright 2016  I am Adam Taylor  (email : sayhi@iamadamtaylor.com)
...
if ( function_exists( 'register_nav_menus' ) ) {
    register_nav_menus( array(
        ...
        "secondary_menu" => "Secondary Menu - Sidebar",
        "site_map" => 'Site Map'
    ) );
}

function wdm_get_menu_name ( $menu_location, $echo = false ) {
...
function wdm_get_link_tag ( $menu_item, $args = array() ) {
    $defaults = array(
        'before' => '',
        'after' => '',
        'classes' => ''
...
if ( !class_exists( 'WP_Developer_Menu' ) ) {

    class WP_Developer_Menu {
